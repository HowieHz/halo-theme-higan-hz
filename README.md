...
启用“首页样式 - 多语言公告栏前缀匹配模式”，启用此项将允许“语言”设置值符合 navigator.language 值前缀即显示，而无需完全匹配。（注：开启了这项之后，下面的“zh”可匹配 zh_CN，zh_TW 等 navigator.language 值。）
以上菜单可改为：
...
“默认多语言公告栏名称”默认值为 defalut，你也可以设定为如 zh_CN，但是要注意这里是**完全匹配“语言”设置值**，即使开启了“多语言菜单前缀匹配模式”。
