...
| `photos.html`  | 图库页面           | `/photos(?group={groupName})`              | [plugin-photos](https://github.com/halo-sigs/plugin-photos)           |
...
| 文件位置                                        | 介绍                 | 依赖插件                                                                                                                           |
| ----------------------------------------------- | -------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `src/templates/components/halo-comment-widget/` | 官方评论组件样式适配 | [plugin-comment-widget](https://github.com/halo-dev/plugin-comment-widget?tab=readme-ov-file#%E4%B8%BB%E9%A2%98%E9%80%82%E9%85%8D) |
