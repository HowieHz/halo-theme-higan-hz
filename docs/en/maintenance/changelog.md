...
- Improved hover text rendering for desktop and tablet post page top action buttons, preventing multiple labels from showing at once while quickly moving across buttons.
