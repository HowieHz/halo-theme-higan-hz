...
hero:
  name: "Higan Haozi"
  text: "A responsive, clean Halo CMS theme for personal websites"
  tagline: "An all-in-one experience that is multilingual, highly configurable, and widely compatible"
  actions:
    - theme: brand
