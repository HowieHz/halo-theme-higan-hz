...
Navigate to the ["General Styling -> Custom Color Scheme"](/en/guide/theme-configuration#custom-color-scheme) configuration item. As shown below, click the add button:
