...
更多能力会在《[配置总览](./configuration-overview.md)》《[内容增强与多语言](./content-components.md)》《[进阶功能](./advanced.md)》与《[模板映射与页面路径](../reference/template-map.md)》中逐一展开。
...
1. 《[快速开始](./getting-started.md)》：安装、升级、构建流程。
2. 《[配置总览](./configuration-overview.md)》：后台表单逐项说明。
3. 《[i18n 支持指南](./i18n.md)》：多语言菜单、公告、页面语言与元数据配置。
4. 《[内容增强与多语言](./content-components.md)》：主题特有组件、明暗模式内容与编辑器写法。
5. 《[进阶功能](./advanced.md)》：CDN、防镜像、Mermaid、安全策略、插件集成。
