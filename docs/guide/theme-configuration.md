...
::: info 📂 配置项位置
<!-- markdownlint-disable MD051 -->
（[总体样式 -> 添加内容到页面最底部/侧边栏](#添加内容到页面最底部-侧边栏) 或 [总体样式 -> 多语言页面底部/侧边栏内容支持](#多语言页面底部-侧边栏内容支持) 启用，且 [内容显示方式](#内容显示方式) 不为 `内联（页面底部）` 时显示）
<!-- markdownlint-enable MD051 -->
总体样式 -> 悬浮透明度
...
<QuickJumpConfig to="/console/theme/settings/styles#:~:text=悬浮透明度" />
...
<QuickJumpConfig to="/console/theme/settings/styles#:~:text=平板和手机端行为" />
