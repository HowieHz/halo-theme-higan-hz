...
- 优化[“深色正文样式预设”](/guide/theme-configuration#深色正文样式预设)中的 `轻柔灰` 预设，不仅让深色模式下的正文字体观感更柔和，也让深色字体/标题与正文字体的对比更明显。
...
- 新增[“深色正文样式预设”](/guide/theme-configuration#深色正文样式预设)配置项（总体样式 -> 深色正文样式预设），提供 `轻柔灰` 预设，可让深色模式下的正文文字观感更柔和，减轻纯白文字带来的偏亮、偏粗观感。
