import "./styles.css";
import { isVisible } from "../../ts-components/animations/base";
import { fadeIn } from "../../ts-components/animations/fade-in";
import { fadeOut } from "../../ts-components/animations/fade-out";
