...
async function main() {
  try {
    ...
    lines.push('');
    lines.push('Extracted from `manifest.json` generated by Lighthouse CI. Scores are 0-100.');
    lines.push('');
    ...
    for (const entry of manifest) {
      ...
      const bp = typeof s['best-practices'] === 'number' ? Math.round(s['best-practices'] * 100) : (typeof s.bestPractices === 'number' ? Math.round(s.bestPractices * 100) : '-');
