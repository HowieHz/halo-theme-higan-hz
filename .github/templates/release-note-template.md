...
> `howiehz-higan-zh-hans-tiny.zip` 为简体中文轻量安装包，仅保留 `.woff2` 默认字体，默认 logo 资源将替换为 1x1 占位图，且不包含预压缩文件。
...
> `howiehz-higan-en-tiny.zip` is the English tiny package that keeps only the default `.woff2` fonts, replaces the default logo asset with a 1x1 placeholder image, and omits precompressed assets.
