...
async function reloadTheme(authToken, themeName) {
  ...
  const response = await fetch(`${HALO_URL}/apis/api.console.halo.run/v1alpha1/themes/${themeName}/reload`, {
    method: "PUT",
    headers: {
      Cookie: authToken,
    },
...
async function activateTheme(authToken, themeName) {
  ...
  const response = await fetch(`${HALO_URL}/apis/api.console.halo.run/v1alpha1/themes/${themeName}/activation`, {
    method: "PUT",
    headers: {
      Cookie: authToken,
    },
...
async function invalidateCache(authToken, themeName) {
  ...
  const response = await fetch(`${HALO_URL}/apis/api.console.halo.run/v1alpha1/themes/${themeName}/invalidate-cache`, {
    method: "PUT",
    headers: {
      Cookie: authToken,
    },
