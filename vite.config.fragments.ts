  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "fragments-post-list-simple": path.resolve(__dirname, "src/templates/fragments/post-list/simple.html"),
        "fragments-post-list-summary": path.resolve(__dirname, "src/templates/fragments/post-list/summary.html"),
      },
    },
  },
});
